...
// Kurze Marken-Ladeseite beim ersten Aufruf (~2s gesamt): T-Badge, "TaskOrga"
// tippt sich ein, dann kurz die Tagline -- danach faded sie aus dem Weg.
// Respektiert prefers-reduced-motion (kein Zeichen-fuer-Zeichen-Tippen, aber
// gleiche Gesamtdauer, damit das Branding trotzdem kurz sichtbar ist).
